#!/usr/bin/env bun
"use strict";var kn=Object.create;var Be=Object.defineProperty;var Mn=Object.getOwnPropertyDescriptor;var Pn=Object.getOwnPropertyNames;var $n=Object.getPrototypeOf,Fn=Object.prototype.hasOwnProperty;var _=(e,t)=>()=>(e&&(t=e(e=0)),t);var ue=(e,t)=>{for(var n in t)Be(e,n,{get:t[n],enumerable:!0})},Un=(e,t,n,s)=>{if(t&&typeof t=="object"||typeof t=="function")for(let r of Pn(t))!Fn.call(e,r)&&r!==n&&Be(e,r,{get:()=>t[r],enumerable:!(s=Mn(t,r))||s.enumerable});return e};var xe=(e,t,n)=>(n=e!=null?kn($n(e)):{},Un(t||!e||!e.__esModule?Be(n,"default",{value:e,enumerable:!0}):n,e));function D(){return parseInt(process.env.QREC_PORT??"25927",10)}var U,ot,T,Ms,it,W,q,pe,H,we,me,J,ge,M=_(()=>{"use strict";U=require("path"),ot=require("os"),T=process.env.QREC_DIR??(0,U.join)((0,ot.homedir)(),".qrec"),Ms=parseInt(process.env.QREC_PORT??"25927",10);it=(0,U.join)(T,"qrec.db"),W=(0,U.join)(T,"qrec.pid"),q=(0,U.join)(T,"enrich.pid"),pe=(0,U.join)(T,"enrich-progress.json"),H=(0,U.join)(T,"qrec.log"),we=(0,U.join)(T,"activity.jsonl"),me=(0,U.join)(T,"config.json"),J=(0,U.join)(T,"models"),ge=(0,U.join)(T,"archive")});function jn(){let e=process.env.BREW_PREFIX||process.env.HOMEBREW_PREFIX,t=[];e&&(t.push(`${e}/opt/sqlite/lib/libsqlite3.dylib`),t.push(`${e}/lib/libsqlite3.dylib`)),t.push("/opt/homebrew/opt/sqlite/lib/libsqlite3.dylib"),t.push("/usr/local/opt/sqlite/lib/libsqlite3.dylib");for(let n of t)try{if((0,Ie.statSync)(n).size>0)return n}catch{}return null}function te(e=He){let t=e.replace(/\/[^/]+$/,"");(0,Ie.mkdirSync)(t,{recursive:!0});let n=new qe.Database(e);return n.loadExtension(Bn),n.exec("PRAGMA journal_mode = WAL"),n.exec("PRAGMA synchronous = NORMAL"),n.exec("PRAGMA cache_size = -32000"),n.exec("PRAGMA foreign_keys = ON"),qn(n),n}function qn(e){e.exec(`
...
Then set BREW_PREFIX if Homebrew is in a non-standard location.`);qe.Database.setCustomSQLite(e)}Bn=(0,at.getLoadablePath)()});function lt(e){if(e.length<=3600)return[{text:e,pos:0}];let t=Hn(e),n=[],s="",r=0;for(let o of t){let i=s?s+`

`+o.text:o.text;if(i.length<=3600)s||(r=o.pos),s=i;else if(s){n.push({text:s.trim(),pos:r});let a=s.slice(-ct),d=r+s.length-a.length;s=a+`

`+o.text,r=d}else{let a=Gn(o.text,o.pos);if(a.length>1){for(let u=0;u<a.length-1;u++)n.push(a[u]);let d=a[a.length-1];s=d.text,r=d.pos}else s=o.text,r=o.pos}}return s.trim()&&n.push({text:s.trim(),pos:r}),n}function Hn(e){let t=/^(#{1,6} .+)$/m,n=[],s=0,r=[],o,i=/^(#{1,6} .+)$/gm;for(;(o=i.exec(e))!==null;)o.index>0&&r.push(o.index);if(r.length===0)return[{text:e,pos:0}];for(let d of r){let u=e.slice(s,d);u.trim()&&n.push({text:u.trim(),pos:s}),s=d}let a=e.slice(s);return a.trim()&&n.push({text:a.trim(),pos:s}),n.length>0?n:[{text:e,pos:0}]}function Gn(e,t){let n=[],s=0;for(;s<e.length;){let r=s+3600;if(r>=e.length){n.push({text:e.slice(s).trim(),pos:t+s});break}let o=e.lastIndexOf(`

`,r);if(o>s+3600*.5)r=o;else{let i=e.lastIndexOf(`
`,r);i>s+3600*.5&&(r=i)}n.push({text:e.slice(s,r).trim(),pos:t+s}),s=Math.max(s+1,r-ct)}return n}var ct,dt=_(()=>{"use strict";ct=Math.floor(540)});var S,Ne=_(()=>{"use strict";S={phase:"starting",modelDownload:{percent:0,downloadedMB:0,totalMB:null},indexing:{indexed:0,total:0,current:""}}});function N(e){let t={ts:Date.now(),...e};try{(0,X.mkdirSync)(T,{recursive:!0}),(0,X.appendFileSync)(we,JSON.stringify(t)+`
...
`)}var xt,be,j,Je=_(()=>{"use strict";xt=require("crypto"),be=require("fs"),j=require("path")});function os(e){let t=[];for(let n of(0,C.readdirSync)(e)){let s=(0,ne.join)(e,n);if((0,C.statSync)(s).isDirectory())for(let r of(0,C.readdirSync)(s))r.endsWith(".jsonl")&&t.push((0,ne.join)(s,r));else n.endsWith(".jsonl")&&t.push(s)}return t}function is(e){return function(){e|=0,e=e+1831565813|0;let t=Math.imul(e^e>>>15,1|e);return t=t+Math.imul(t^t>>>7,61|t)^t,((t^t>>>14)>>>0)/4294967296}}function as(e,t,n){let s=is(n),r=[...e];for(let o=r.length-1;o>0;o--){let i=Math.floor(s()*(o+1));[r[o],r[i]]=[r[i],r[o]]}return r.slice(0,t)}async function Nt(e,t=2){try{let n=await Re(e);if(n.turns.filter(o=>o.role==="user").length<t)return null;let r=It(n);return r.trim()?{id:n.session_id,path:e,project:n.project,date:n.date,title:n.title,hash:n.hash,duration_seconds:n.duration_seconds,last_message_at:n.last_message_at,chunkText:r}:null}catch(n){return console.warn("[indexer] Failed to parse JSONL:",e,n),null}}function cs(e,t,n){if(!e.startsWith(n))try{let s=(0,ne.join)(n,t);(0,C.mkdirSync)(s,{recursive:!0}),(0,C.copyFileSync)(e,(0,ne.join)(s,(0,ne.basename)(e)))}catch(s){console.warn(`[indexer] Archive failed for ${e}: ${s}`)}}async function ye(e,t,n={},s,r){let o=r??await Ae(),i=t.endsWith(".jsonl")&&(0,C.existsSync)(t),a=!i&&(0,C.existsSync)(t)&&(0,C.statSync)(t).isDirectory(),d=new Map,u=e.prepare("SELECT path, indexed_at FROM sessions").all();for(let h of u)d.set(h.path,h.indexed_at);let l=[];if(i){let h=await Nt(t,vt);if(!h){console.log("[indexer] Session skipped (too few user turns or empty)");return}l=[h]}else if(a){let h=os(t),L=n.force?h:h.filter($=>{let ie=d.get($);return ie?(0,C.statSync)($).mtimeMs>=ie:!0}),Z=h.length-L.length;console.log(`[indexer] Found ${h.length} JSONL files (${Z} skipped by mtime, ${L.length} to check)`),l=(await Promise.all(L.map($=>Nt($,vt)))).filter($=>$!==null)}else{console.error(`[indexer] Path not found or not a JSONL/directory: ${t}`);return}let m=new Map,g=e.prepare("SELECT id, hash FROM sessions").all();for(let h of g)m.set(h.id,h.hash);if(n.sessions&&n.sessions<l.length){let h=n.seed??42;l=as(l,n.sessions,h),console.log(`[indexer] Sampled ${l.length} sessions (seed=${h})`)}let f=l.filter(({id:h,hash:L})=>n.force?!0:m.get(h)!==L),A=l.length-f.length,c=i?1:l.length;console.log(`[indexer] ${f.length} sessions to index (${c} total, ${A} up-to-date)`);let b=e.prepare(`
  ...
  `),P=e.prepare(`
    ...
    VALUES (?, ?)
  `),Q=e.prepare("DELETE FROM chunks WHERE session_id = ?"),z=e.prepare("DELETE FROM chunks_vec WHERE chunk_id LIKE ?");for(let h=0;h<f.length;h++){let{id:L,path:Z,project:oe,date:$,title:ie,hash:Se,duration_seconds:Fe,last_message_at:Ue,chunkText:je}=f[h],de=n.archiveDir===void 0?ge:n.archiveDir;de!==null&&cs(Z,oe,de);let Te=lt(je),p=Date.now(),R=e.transaction(()=>(Q.run(L),z.run(`${L}_%`),b.run(L,Z,oe,$,ie,Se,p,Fe,Ue),Te))();process.stdout.write(`[${h+1}/${f.length}] ${L} (${oe}/${$}) \u2014 ${R.length} chunks
`),s?.(h,f.length,L);let I=e.transaction(O=>{for(let{chunkId:B,seq:F,pos:ee,text:Dn,embedding:Cn}of O)w.run(B,L,F,ee,Dn,p),P.run(B,Buffer.from(Cn.buffer))}),y=[];for(let O=0;O<R.length;O++){let B=R[O],F=`${L}_${O}`,ee=await o.embed(B.text);y.push({chunkId:F,seq:O,pos:B.pos,text:B.text,embedding:ee})}I(y)}s?.(f.length,f.length,""),console.log(`[indexer] Done. Total sessions indexed: ${f.length}`)}async function At(e,t){let n=e.prepare(`
    SELECT c.id, c.text FROM chunks c
    LEFT JOIN chunks_vec v ON v.chunk_id = c.id
    WHERE c.seq = -1 AND v.chunk_id IS NULL
  `).all();if(n.length===0)return;console.log(`[indexer] Embedding ${n.length} summary chunk(s) into chunks_vec`);let s=e.prepare("INSERT OR REPLACE INTO chunks_vec (chunk_id, embedding) VALUES (?, ?)");for(let{id:r,text:o}of n){let i=await t.embed(o);s.run(r,Buffer.from(i.buffer))}console.log("[indexer] Summary chunks embedded.")}var C,ne,vt,Xe=_(()=>{"use strict";C=require("fs"),ne=require("path");M();dt();We();Je();vt=2});function Mt(e,t){for(let n of t)for(let s of e){let r=`${n}/${s}`;if((0,G.existsSync)(r)){let o=s.match(/\.so\.(\d+)/);return{path:r,soVersion:o?.[1]??null}}}return null}function us(){try{let e=Bun.spawnSync(["nvidia-smi","--query-gpu=name,driver_version","--format=csv,noheader,nounits"]);if(e.exitCode!==0||!e.stdout)return null;let t=e.stdout.toString("utf-8").trim().split(", ");if(t.length<2)return null;let n=t[0].trim(),s=t[1].trim(),o=Bun.spawnSync(["nvidia-smi"]).stdout?.toString("utf-8").match(/CUDA Version:\s*([\d.]+)/);return{name:n,driver:s,cudaVersion:o?.[1]??"unknown"}}catch{return null}}function ps(){try{let e=(0,G.readFileSync)("/etc/os-release","utf-8"),t={};for(let n of e.split(`
`)){let s=n.match(/^(\w+)="?([^"]*)"?$/);s&&(t[s[1]]=s[2])}return t}catch{return{}}}function ms(){return(0,G.existsSync)("/usr/bin/apt-get")?"apt":(0,G.existsSync)("/usr/bin/dnf")?"dnf":(0,G.existsSync)("/usr/bin/yum")?"yum":(0,G.existsSync)("/usr/bin/pacman")?"pacman":"unknown"}function gs(){try{return(0,G.readdirSync)("/etc/apt/sources.list.d").some(e=>e.startsWith("cuda")||e.includes("nvidia"))}catch{return!1}}function fs(e){let t=e.libcudart,n=e.libcublas;return!t?.found||!n?.found?"linux-x64":t.soVersion==="13"&&n.soVersion==="13"?"linux-x64-cuda":"linux-x64-cuda-ext"}function hs(e,t,n){let s=e.cudaVersion!=="unknown"?e.cudaVersion.split(".").slice(0,2).join("-"):"12-8",r=s.split("-")[0],o=[];if(t==="apt"){if(!n){let i=ps(),a=i.ID?.toLowerCase()??"ubuntu",d=i.VERSION_ID?.replace(".","")??"2204";o.push(`wget https://developer.download.nvidia.com/compute/cuda/repos/${a}${d}/x86_64/cuda-keyring_1.1-1_all.deb`),o.push("sudo dpkg -i cuda-keyring_1.1-1_all.deb && sudo apt-get update")}o.push(`sudo apt install -y cuda-cudart-${s} libcublas-${s}`)}else t==="dnf"||t==="yum"?o.push(`sudo ${t} install -y cuda-cudart-${s} libcublas-${s}`):t==="pacman"?o.push("sudo pacman -S cuda"):(o.push("# Install CUDA runtime libs from your package manager or the NVIDIA CUDA toolkit"),o.push(`# Required: libcudart.so.${r}, libcublas.so.${r}, libcublasLt.so.${r}`));return o.push("qrec teardown && qrec serve --daemon"),o}function se(){if(le)return le;if(process.platform!=="linux")return le={gpuDetected:!1,gpuName:null,driverVersion:null,cudaDriverVersion:null,cudaRuntimeAvailable:!1,vulkanAvailable:!1,missingLibs:[],libProbes:{},selectedBackend:"cpu",activeBinaryName:null,pkgManager:"unknown",cudaRepoConfigured:null,advice:null,installSteps:null},le;let e=us(),t={},n=[];for(let g of ds){let f=Mt(g.variants,kt);t[g.name]={found:f!==null,path:f?.path??null,soVersion:f?.soVersion??null},f||n.push(g.name)}let s=Mt(["libvulkan.so","libvulkan.so.1"],kt),r=e!==null&&n.length===0,o=s!==null,i=r?"cuda":o?"vulkan":"cpu",a=r?fs(t):"linux-x64",d=ms(),u=d==="apt"?gs():null,l=null,m=null;return e&&!r&&(l=`GPU detected (${e.name}) but CUDA runtime libs missing: ${n.join(", ")}.`,m=hs(e,d,u)),le={gpuDetected:e!==null,gpuName:e?.name??null,driverVersion:e?.driver??null,cudaDriverVersion:e?.cudaVersion??null,cudaRuntimeAvailable:r,vulkanAvailable:o,missingLibs:n,libProbes:t,selectedBackend:i,activeBinaryName:a,pkgManager:d,cudaRepoConfigured:u,advice:l,installSteps:m},le}var G,kt,ds,le,Oe=_(()=>{"use strict";G=require("node:fs"),kt=["/usr/lib","/usr/lib64","/usr/lib/x86_64-linux-gnu","/usr/lib/aarch64-linux-gnu","/usr/local/cuda/lib64","/usr/local/cuda/targets/x86_64-linux/lib","/usr/local/cuda/targets/aarch64-linux/lib",...process.env.LD_LIBRARY_PATH?.split(":").filter(Boolean)??[],...process.env.CUDA_PATH?[`${process.env.CUDA_PATH}/lib64`]:[]],ds=[{name:"libcudart",variants:["libcudart.so","libcudart.so.11","libcudart.so.12","libcudart.so.13"]},{name:"libcublas",variants:["libcublas.so","libcublas.so.11","libcublas.so.12","libcublas.so.13"]},{name:"libcublasLt",variants:["libcublasLt.so","libcublasLt.so.11","libcublasLt.so.12","libcublasLt.so.13"]}];le=null});function K(e=me){try{let t=JSON.parse((0,Y.readFileSync)(e,"utf-8"));return{...Pt,...t}}catch(t){return t.code!=="ENOENT"&&console.warn("[config] Failed to parse config.json, using defaults:",t),{...Pt}}}function $t(e=me){(0,Y.existsSync)(e)||Ke({},e)}function Ke(e,t=me){let s={...K(t),...e},r=t===me?T:t.replace(/\/[^/]+$/,"");return(0,Y.mkdirSync)(r,{recursive:!0}),(0,Y.writeFileSync)(t,JSON.stringify(s,null,2),"utf-8"),s}var Y,Pt,De=_(()=>{"use strict";Y=require("fs");M();Pt={enrichEnabled:!0,enrichIdleMs:300*1e3,indexIntervalMs:6e4}});var Ft,Ut=_(()=>{"use strict";Ft=`You are a concise technical summarizer for AI coding sessions.
...
- No explanation outside the JSON block`});function Es(e,t=6e3){let n=e.split(`
`),s=[],r=0;for(let o of n)if(!o.startsWith("[Tool]")){if(r+o.length>t){s.push("... (truncated)");break}s.push(o),r+=o.length+1}return s.join(`
`)}function Ce(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function bs(e){let t=e.replace(/<think>[\s\S]*?<\/think>/g,"").trim(),n=t.match(/\{[\s\S]*\}/);if(!n)return{title:"",summary:t.slice(0,500)||"",tags:[],entities:[],learnings:[],questions:[]};try{let s=JSON.parse(n[0]);return{title:typeof s.title=="string"?s.title:"",summary:typeof s.summary=="string"?s.summary:"",tags:Ce(s.tags),entities:Ce(s.entities),learnings:Ce(s.learnings),questions:Ce(s.questions)}}catch{return{title:"",summary:"",tags:[],entities:[],learnings:[],questions:[]}}}async function jt(e,t){let{LlamaChatSession:n}=await import("node-llama-cpp"),s=e.ctx.getSequence(),r=new n({contextSequence:s,systemPrompt:Ft}),i=`/no_think

Transcript:

${Es(t)}

JSON summary:`;try{let a=await r.prompt(i,{maxTokens:600,temperature:.1});return bs(a)}catch{return{title:"",summary:"",tags:[],entities:[],learnings:[],questions:[]}}finally{s.dispose()}}var Bt=_(()=>{"use strict";Ut()});var Gt={};ue(Gt,{ENRICHMENT_VERSION:()=>V,ENRICH_PID_FILE:()=>q,disposeSummarizer:()=>Ze,isEnrichAlive:()=>et,isProcessAlive:()=>Me,loadSummarizer:()=>qt,readEnrichPid:()=>ke,runEnrich:()=>Ts});function ke(){if(!(0,k.existsSync)(q))return null;let e=parseInt((0,k.readFileSync)(q,"utf-8").trim(),10);return isNaN(e)?null:e}function Me(e){try{return process.kill(e,0),!0}catch{return!1}}function et(){let e=ke();return e!==null&&Me(e)}function ys(e){(0,k.mkdirSync)(T,{recursive:!0}),(0,k.writeFileSync)(q,String(e),"utf-8")}function ze(){try{(0,k.unlinkSync)(q)}catch{}}async function qt(){let{resolveModelFile:e,getLlama:t}=await import("node-llama-cpp");(0,k.mkdirSync)(J,{recursive:!0}),process.stdout.write(`[enrich] Resolving model...
`);let n=-1,s=!1,r=null,o=await e(Rs,{directory:J,onProgress({totalSize:u,downloadedSize:l}){s=!0;let m=u?Math.round(l/u*100):0;if(process.stdout.write(`\r[enrich] Downloading model... ${m}%`),Math.abs(m-n)>=5){n=m;let g=u?Math.round(u/1024/1024):null;r=g;let f=Math.round(l/1024/1024);try{(0,k.writeFileSync)(pe,JSON.stringify({percent:m,downloadedMB:f,totalMB:g}),"utf-8")}catch{}}}});s&&process.stdout.write(`
`),process.stdout.write(`[enrich] Model ready at ${o}
`);let i=await t(),a=await i.loadModel({modelPath:o}),d=await a.createContext({contextSize:8192,sequences:1,flashAttention:!0});console.log("[enrich] Model loaded.");try{(0,k.unlinkSync)(pe)}catch{}return s&&N({type:"enrich_model_downloaded",data:{totalMB:r}}),N({type:"enrich_model_loaded"}),{llama:i,model:a,ctx:d}}async function Ze(e){await e.ctx.dispose(),await e.model.dispose(),await e.llama.dispose()}function _s(e,t){return e.prepare("SELECT text FROM chunks WHERE session_id = ? ORDER BY seq").all(t).map(s=>s.text).join(`
